    ...
    <section className='bg-gradient-to-t from-costumegray to-costumperpel overflow-auto '>
     <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 " data-aos="fade-left">
            ...
            <h2 className="h2 text-3xl sm:text-4xl text-white font-mono uppercase mb-4">Which Sectors are More Exposed to Commodities Risk?</h2>
            <ul className="sm:text-lg text-base text-gray-400 -mb-2 sm:ml-48">
